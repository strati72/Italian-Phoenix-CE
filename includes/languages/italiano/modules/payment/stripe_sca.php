...
*/
  ...
  const MODULE_PAYMENT_STRIPE_SCA_ERROR_ADMIN_CURL = 'Questo modulo richiede l\'abilitazione del modulo PHP cURL and will not load until it has been enabled on this webserver.';
