...
const TEXT_DISPLAY_NUMBER_OF_PRODUCTS = 'Visualizzo <strong>%d</strong> su <strong>%d</strong> (di <strong>%d</strong> prodotti)';

const PREVNEXT_TITLE_FIRST_PAGE = 'Pagina iniziale';
const PREVNEXT_TITLE_PREVIOUS_PAGE = 'Pagina precedente';
const PREVNEXT_TITLE_NEXT_PAGE = 'Pagina successina';
...
const TEXT_DESCENDINGLY = 'Ordina per %s Discendente';
const TEXT_ASCENDINGLY = 'Ordina per %s Ascendente';
...
const TABLE_HEADING_ORDERED = 'Più venduto';
